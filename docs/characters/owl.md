...
몸매   공 두 개를 겹친 눈사람 모양. 목이 없다.
       ** 옆에서 봐도 똑같이 통통하다. ** 가슴에서 등까지의 두께가 정면에서 본
       어깨 폭의 85% 이상이다. 참새나 앵무새 같은 홀쭉한 옆모습은 이 캐릭터가 아니다.
머리   몸통만큼 크다. 머리 위 양쪽에 뾰족한 깃뿔 두 개.
얼굴   크림색 얼굴 원반이 넓게 깔리고 그 위에 크고 동그란 눈 두 개.
       눈 하나가 얼굴 원반 폭의 1/3 을 차지할 만큼 크다. 눈썹은 없다.
눈     ** 흰자 · 눈동자 · 흰 점 세 겹. 통짜로 채우지 마라. **
       흰 눈알을 크고 둥글게 깔고, 그 안에 남색 눈동자를 놓고,
       눈동자 안에 흰 점 하나를 찍는다.
       ** 눈동자는 흰자보다 확실히 작다 ** — 흰자가 넓게 보여야 멍하고 귀엽다.
       눈을 꽉 채우면 야무지고 사나워 보인다.
주둥이 작은 주황색 마름모 부리 하나. 두 눈 사이 아래에 붙는다.
배     밝은 하늘색 타원이 몸통 앞을 크게 덮는다.
앞다리 ** 이 캐릭터의 "붙잡는 앞다리" 는 날개다. **
       몸 양옆에 붙은 둥근 주걱 모양. 진한 파랑. 깃털을 한 올씩 그리지 않는다 —
       한 덩어리 단색이다.
뒷다리 짧고 굵은 주황색 다리 두 개, 발가락 셋.
       ** 몸통 아래로 살짝 삐져나와 보인다. 길이는 전체 키의 15%. **
       길게 만들지 마라 — 사람 다리가 아니다. 다만 아래 15% 에는 다리와 발만 있어야
       한다(몸통이 바닥까지 내려오면 안 된다).
       평소 칸에서도 보여야 한다 — 걷기 · 걸터앉기 · 거꾸로가 이 다리를 쓴다.

색     아래 여섯 색과 흰자 · 윤곽선, 모두 여덟 색만 쓴다. 다른 색을 만들지 마라.
       흰자          #FFFFFF
       몸 · 깃뿔     #3A72C4
       날개 · 그늘   #27548F
       배            #9FC4EE
       ...
       얼굴 → #D6D6D6  부리·다리 → #ADADAD   눈 → #1F1F1F
```
