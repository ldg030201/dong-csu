...
> 그 판정은 [`ClaudeIconStyle.isAnimated`](../../Sources/DongCSU/ClaudeIcon.swift)에 있다.
...
2. [`ClaudeIconStyle`](../../Sources/DongCSU/ClaudeIcon.swift)에 항목을 더하고 `group`을 `.character`로 둔다
