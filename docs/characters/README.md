...
**그림 한 장과 코드 한 줄이다.** 24칸에 자세를 나눠 담은 시트를 규격대로 만들어
`mac/Resources/<이름>.png` 에 두고, [`ClaudeIconStyle`](../../mac/Sources/DongCSU/ClaudeIcon.swift)에
케이스를 하나 더한다. 규격·프롬프트·다듬는 법은 **[캐릭터 만들기](making.md)**.
