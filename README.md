...
- 라이트·다크 테마, 배경 불투명도, 펼침 방향을 고를 수 있다
...
설정 창(톱니 버튼 또는 `⌘,`)에서 현재 사용량, 테마, 가운데 아이콘(실제로 그려서
보여주고 고른다), 조회 주기, 펼침 방향, 배경 불투명도, 접기, HUD 표시,
위치 초기화, 재로그인을 한 화면에서 볼 수 있다.

가운데 아이콘은 **캐릭터**와 **Claude** 두 묶음으로 나눠 놓았다. 앞은 dong-mcu가
직접 만든 그림이고, 뒤는 Claude 쪽 그림이다.
