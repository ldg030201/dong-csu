...
> [!WARNING]
> **아직 만드는 중입니다.** 받아서 쓸 수 있는 버전이 없습니다.
> 지금 무엇이 되고 무엇이 안 되는지는 아래 [진행 상황](#진행-상황)에 적어 둡니다.
...
맥 판 2.1.0 기준으로 옮기고 있습니다. **펫 모드는 첫 배포에 넣지 않습니다** —
...
- .NET 런타임은 따로 안 깔아도 됩니다 (앱에 들어 있습니다)
